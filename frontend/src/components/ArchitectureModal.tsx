...
export function ArchitectureModal({ isOpen, onClose }: ArchitectureModalProps) {
  ...
  return (
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-zinc-950/90 p-4 backdrop-blur-none font-mono">
        <motion.div
          initial={{ opacity: 0, scale: 0.98 }}
          animate={{ opacity: 1, scale: 1 }}
          exit={{ opacity: 0, scale: 0.98 }}
          className="relative w-full max-w-4xl border border-zinc-700 bg-[#18181b] p-5 shadow-none rounded-none"
        >
          {/* Close button */}
          <button
            onClick={onClose}
            className="absolute right-4 top-4 rounded-none border border-zinc-700 p-1 text-zinc-400 hover:bg-zinc-800 hover:text-white transition-none"
          >
            <X className="h-4 w-4" />
          </button>
          ...
          <div className="flex items-center gap-2.5 mb-5 pb-3 border-b border-zinc-800">
            <div className="flex h-9 w-9 items-center justify-center rounded-none bg-zinc-950 text-indigo-400 border border-zinc-700">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-3 relative font-mono">
            {/* Tier 1 */}
            <div className="rounded-none border border-amber-500/50 bg-zinc-950 p-3.5 flex flex-col justify-between">
              <div>
                <div className="flex items-center justify-between mb-2.5">
                  <span className="text-[9px] font-bold text-amber-500 uppercase tracking-wider px-1.5 py-0.2 rounded-none bg-amber-950 border border-amber-500/40">
                    Tier 1
                  </span>
                  <CloudSun className="h-4 w-4 text-amber-500" />
                </div>
                <h3 className="font-bold text-white text-xs mb-1 font-mono">Telemetric Ingestion</h3>
                <p className="text-[11px] text-zinc-400 mb-2.5 leading-relaxed font-sans">
            ...
            {/* Tier 2 */}
            <div className="rounded-none border border-teal-500/50 bg-zinc-950 p-3.5 flex flex-col justify-between">
              <div>
                <div className="flex items-center justify-between mb-2.5">
                  <span className="text-[9px] font-bold text-teal-400 uppercase tracking-wider px-1.5 py-0.2 rounded-none bg-teal-950 border border-teal-500/40">
                    Tier 2
                  </span>
              ...
              <ul className="text-[10px] text-teal-400 space-y-1 font-mono">
            ...
            {/* Tier 3 */}
            <div className="rounded-none border border-emerald-500/50 bg-zinc-950 p-3.5 flex flex-col justify-between">
              <div>
                <div className="flex items-center justify-between mb-2.5">
                  <span className="text-[9px] font-bold text-emerald-500 uppercase tracking-wider px-1.5 py-0.2 rounded-none bg-emerald-950 border border-emerald-500/40">
                    Tier 3
                  </span>
              ...
              <ul className="text-[10px] text-emerald-400 space-y-1 font-mono">
            ...
            {/* Tier 4 */}
            <div className="rounded-none border border-indigo-500/50 bg-zinc-950 p-3.5 flex flex-col justify-between">
              <div>
                <div className="flex items-center justify-between mb-2.5">
          ...
          <div className="mt-5 flex flex-wrap items-center justify-between gap-3 rounded-none border border-zinc-800 bg-zinc-950 p-3 font-mono">
